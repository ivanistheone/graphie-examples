...
var drawNsidedPrism = function(radiusTop, radiusBottom, height, Nsegments, options) {
    ...
    if (SHOW_SECANT_PLANE) {
        ...
        faces.push({    // secant in solid
            verts: _.range(2*Nsegments+5,2*Nsegments+5+5),
...
var prism = drawNsidedPrism(0, 2/sqrt(2), 2, 4, { } );
...
if (CENTERED) {
    ...
    prism.rotate(0, 0, 1, 1.63+PI+0.4);
}
