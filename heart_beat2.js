...
plot(function(x) {
    ...
    return heart_beat(x,2/3,VMAX)+ 
heart_beat(x,4/3,VMAX) + 
heart_beat(x,6/3,VMAX) + 
heart_beat(x,8/3,VMAX) + 
heart_beat(x,10/3,VMAX) + 
heart_beat(x,12/3,VMAX) + 
heart_beat(x,14/3,VMAX) + 
heart_beat(x,16/3,VMAX) + 
heart_beat(x,18/3,VMAX) + 
heart_beat(x,20/3,VMAX) + 
heart_beat(x,0,VMAX) +
heart_beat(x,-2/3,VMAX);
}, X_RANGE);
